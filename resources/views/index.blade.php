            ...
            <div class="lg:col-span-8 relative">
                ...
                @if (!empty($hero?->banner_url))
                    <div class="hidden lg:block relative">
                        <img src="{{ $hero->banner_url }}" alt="Hero Utama" class="w-full h-96 lg:h-[500px] object-cover">
                        @if (!empty($hero?->desk))
                            <div
            ...
            <div class="hidden md:grid grid-cols-3 gap-4 mt-24">
                @if (!empty($hero?->sec1_url))
                    <div class="aspect-[4/3]">
                        <img src="{{ $hero->sec1_url }}" alt="Hero Sekunder 1" class="w-full h-56 object-cover rounded-lg">
                    </div>
                @endif
                @if (!empty($hero?->sec2_url))
                    <div class="aspect-[4/3]">
