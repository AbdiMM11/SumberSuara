    ...
    <div class="min-h-screen bg-gray-50 py-10 px-4">
        <div class="max-w-5xl mx-auto space-y-6 md:space-y-8">
            ...
            <div
                ...
                <div class="pointer-events-none absolute -right-10 -top-10 w-32 h-32 rounded-full border border-white/10"></div>
                <div class="pointer-events-none absolute -left-16 bottom-0 w-40 h-40 rounded-full border border-white/10"></div>
            ...
            <div class="bg-white rounded-3xl shadow-lg p-4 md:p-6">
                <h3 class="text-sm md:text-base font-semibold text-gray-800 mb-4 flex items-center gap-2">
                    <span class="inline-flex items-center justify-center w-7 h-7 rounded-full bg-blue-100 text-blue-600 text-xs">
                        ℹ️
                    </span>
                    Detail Event
                </h3>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div class="flex items-center gap-3 bg-gray-50/80 p-4 rounded-2xl border border-gray-100">
                        <div class="w-10 h-10 flex items-center justify-center rounded-full bg-orange-100 text-orange-600 text-xl">📅</div>
                        <div class="min-w-0">
                    ...
                    {{-- Lokasi --}}
                    <div class="flex items-center gap-3 bg-gray-50/80 p-4 rounded-2xl border border-gray-100">
                        <div class="w-10 h-10 flex items-center justify-center rounded-full bg-yellow-100 text-yellow-600 text-xl">📍</div>
                        <div class="min-w-0">
                            <p class="text-[11px] text-gray-500 uppercase tracking-wide">Lokasi</p>
                            <p class="font-semibold text-gray-800 text-sm truncate">{{ $event->lokasi }}</p>
                        </div>
                    </div>

                    {{-- Pengisi --}}
                    <div class="flex items-center gap-3 bg-gray-50/80 p-4 rounded-2xl border border-gray-100">
                        <div class="w-10 h-10 flex items-center justify-center rounded-full bg-green-100 text-green-600 text-xl">🎤</div>
                        <div class="min-w-0">
