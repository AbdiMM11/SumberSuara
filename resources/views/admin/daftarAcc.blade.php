                        ...
                        <table class="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                            <thead class="bg-blue-900 text-white">
                                <tr>
                                    ...
                                    <th class="py-3 px-4 text-left whitespace-nowrap hidden md:table-cell">Disetujui Pada</th>
                        ...
                        <table class="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                            <thead class="bg-blue-900 text-white">
                                <tr>
                                    ...
                                    <th class="py-3 px-4 text-left whitespace-nowrap hidden md:table-cell">Jenis Kelamin</th>
                                    <th class="py-3 px-4 text-left whitespace-nowrap">Status Akun</th>
                                    <th class="py-3 px-4 text-center whitespace-nowrap">Aksi</th>
                                </tr>
                            </thead>
