                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-100 mt-1">
                                    Lengkapi informasi event komunitas Sumber Suara dengan jelas dan rapi.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="nama_event" name="nama_event" type="text" value="{{ old('nama_event') }}"
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="pengisi" name="pengisi" type="text" value="{{ old('pengisi') }}"
                            ...
                            <div class="space-y-1.5 md:col-span-2">
                                ...
                                <textarea id="deskripsi" name="deskripsi" rows="4"
                                    ...
                                    class="w-full rounded-2xl border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900
                                       focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition resize-y">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-1.5 md:col-span-2">
                                ...
                                <div class="flex flex-col gap-3 md:flex-row md:items-center">
                                    ...
                                    <input id="flyer" name="flyer" type="file" class="hidden">
                                </div>
