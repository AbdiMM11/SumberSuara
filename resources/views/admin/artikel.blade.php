    ...
    <div class="bg-gray-100 min-h-screen pt-8 md:pt-0">
        <div class="max-w-7xl mx-auto px-4 pb-8">
            <div class="bg-white shadow-md rounded-lg p-4 md:p-6">
                ...
                {{-- Flash success --}}
                @if (session('ok'))
                    <div class="mb-4 rounded-lg bg-green-100 border border-green-300 p-3 text-green-800 text-sm">
                        {{ session('ok') }}
                    </div>
                @endif
                ...
                {{-- Header + actions --}}
                <div
                    class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 space-y-3 md:space-y-0">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch gap-3 w-full md:w-auto">
                        ...
                        <form method="GET" action="{{ route('admin.artikel') }}" class="relative w-full sm:w-56">
                            ...
                            <svg class="absolute left-2.5 top-2.5 w-4 h-4 text-gray-500" fill="none"
                        ...
                        <a href="{{ route('admin.createArtikel') }}"
                            class="flex items-center justify-center gap-2 bg-gray-100 px-4 py-2 text-sm font-medium
                                  text-gray-800 border border-gray-300 rounded-md hover:bg-gray-200 transition">
                        ...
                        <tbody class="bg-gray-50 divide-y divide-gray-200">
                            @forelse ($artikels as $a)
                                <tr class="hover:bg-gray-100 transition">
                                    ...
                                    {{-- Author (desktop/tablet) --}}
                                    <td class="py-3 px-4 text-gray-700 hidden md:table-cell align-top">
                                        {{ $a->author }}
                                    </td>

                                    {{-- Tanggal Rilis (desktop/tablet) --}}
                                    ...
                                    <td class="py-3 px-4 align-top">
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <a href="{{ route('viewArtikel', $a->slug) }}"
                                                ...
                                                title="Lihat">
                                                <img src="{{ asset('public/icons/view.svg') }}" alt="Lihat"
