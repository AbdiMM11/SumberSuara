                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-blue-100 mt-1">
                                Tulis artikel terbaru untuk mengulas kegiatan dan karya komunitas Sumber Suara.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-6 md:px-8 py-6 md:py-8">
                <form action="{{ route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1.5 md:col-span-2">
                            ...
                            <textarea
                                ...
                                name="konten"
                                rows="7"
                                placeholder="Tulis isi artikel di sini. Bisa berisi cerita event, profil musisi, atau insight tentang ekosistem musik lokal."
                    ...
                    <div class="pt-2 flex flex-col md:flex-row md:justify-end gap-3">
                        {{-- Kalau nanti ada route index artikel, bisa tambahkan tombol Batal di sini --}}
                        <button
                            type="submit"
