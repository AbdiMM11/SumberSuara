    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden">
            ...
            <div class="px-6 md:px-8 py-6 md:py-8">
                ...
                <form action="{{ route('musisi.karya.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            {{-- Audio preview --}}
                            <div id="audio-preview-wrapper" class="mt-4 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 shadow-sm hidden">
...
<script>
  ...
  if (audioInput && audioPreview && audioWrapper) {
