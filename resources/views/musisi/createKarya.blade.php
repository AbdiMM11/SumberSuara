        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-100 mt-1">
                                    Unggah lagu baru agar bisa dinikmati audiens Sumber Suara.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="px-6 md:px-8 py-6 md:py-8">
                    ...
                    @if ($errors->any())
                        <div
                            class="mb-4 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 shadow-sm">
                    ...
                    <form action="{{ route('musisi.karya.store') }}" method="POST" enctype="multipart/form-data"
                        class="space-y-8">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <label for="file_mp3"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">
                                            Format MP3, pastikan kualitas audio sudah baik sebelum diupload.
                                        </p>
                                    </div>
                                </label>

                                <input type="file" id="file_mp3" name="file_mp3" accept=".mp3,audio/*" required
                                    class="hidden">
                                @error('file_mp3')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                                ...
                                <div id="audio-preview-wrapper"
                                    class="mt-4 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 shadow-sm hidden">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const audioInput = document.getElementById('file_mp3');
            const audioPreview = document.getElementById('audio-preview');
            const audioWrapper = document.getElementById('audio-preview-wrapper');

            if (!audioInput || !audioPreview || !audioWrapper) return;
